...
//         { name: 'Plans Management', icon: <JobsIcon />, link: '/plans' },
//         { name: 'Roles Management', icon: <JobsIcon />, link: '/roles' },
...
export const Navbar = () => {
  ...
  const navItems = useMemo(() => [
    ...
    { name: 'User Management', icon: <JobsIcon />, link: '/user-management', permission: 'user_management.manage' },

    { name: 'Admin Management', icon: <JobsIcon />, link: '/admin', permission: 'admin_management.manage' },

    { name: 'Category Management', icon: <JobsIcon />, link: '/category', permission: 'category_management.manage' },

    { name: 'Services Management', icon: <JobsIcon />, link: '/services', permission: 'services_management.manage' },

    { name: 'Plans Management', icon: <JobsIcon />, link: '/plans', permission: 'plans_management.manage' },

    { name: 'Roles Management', icon: <JobsIcon />, link: '/roles', permission: 'roles_management.manage' },
    { name: 'KYC & Verification', icon: <JobsIcon />, link: '/kyc-verification', permission: 'user_management.manage'},

    { name: 'Dispute Center', icon: <CoursesIcon />, link: '/dispute-center', permission: 'dispute_management.manage' },

    { name: 'Reports & Analytics', icon: <MessagesIcon />, link: '/reports', permissions: ['analytics_reports.read', 'analytics_reports.manage']  },

    { name: 'Payments & Transactions', icon: <PaymentsIcon />, link: '/payments', permission: 'payments_management.manage' },

    { name: 'Apprenticeship', icon: <CoursesIcon />, link: '/courses', permission: 'courses_management.manage' },

    { name: 'Settings', icon: <SettingsIcon />, link: '/settings', permission: 'settings_management.manage' },
  ], []);
  ...
  useEffect(() => {
    ...
    const found = filteredNavItems.find(item => item.link === current);
  ...
  return (
    <>
      {/* DESKTOP SIDEBAR */}
      <aside className="hidden sm:flex h-screen flex-col w-[308px] p-4 bg-white border-r border-[#DBDBE3]">
        <div className="mb-6">
          <Image
            src="/assets/icons/AppLogo.png"
            alt="Whorkaz Logo"
        ...
        <div className="flex items-center space-x-2 px-2 rounded-xl border mb-6">
             <Image
                src="/assets/images/person3.png"
                alt="Whorkaz Logo"
                width={48}
            ...
            <div className="p-1 ">
                ...
                <div className="text-[16px] text-purple-600 mt-1">
                    {user?.role?.name}
                </div>
            </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 p-3 text-left hover:text-red-500"
        >
          <LogoutIcon />
          Logout
        </button>
      ...
      {/* MOBILE NAV */}
      <nav className="fixed bottom-0 left-0 w-full bg-white shadow sm:hidden">
